            ...
            <div class="container"> 
                <div class="ListDaftar" data-aos="fade-down" data-aos-delay="200">
                    <form action="edit.php" method="POST">
                        <fieldset>
                            <input type="hidden" name="nip" value="<?php echo $list['nip']?>">
                            <p><label for="nama">Nama Tamu : </label>
                                <input type="text" name="nama_tamu" class="form-control" value="<?php echo $list['nama_tamu']?>" readonly></p>
                            <p><label for="tanggal_awal">Tanggal Awal : </label>
                                <input type="date" name="tanggal_awal" class="form-control" value="<?php echo $list['tanggal_awal']?>"></p>
                            <p><label for="tanggal_akhir">Tanggal Akhir : </label>
                                <input type="date" name="tanggal_akhir" class="form-control" value="<?php echo $list['tanggal_akhir']?>"></p>
                            <p><label>Status Check Out : </label>
                            <select name="statusco" class="custom-select">
                                <option value=""><?php echo $list['statusco']?></option>
                                <option value="terisi">Terisi</option>
                                <option value="kosong">Kosong</option>
                            </select> </p>
                            <p><label>Wisma : </label>
                            <select name="wisma" class="custom-select">
                                <option value=""><?php echo $list['wisma']?></option>
                                <option value="handayani">Handayani</option>
                                <option value="anggrek">Anggrek</option>
                            </select> </p>
                            <p><label for="nomor_kamar">No. Kamar: </label>
                                <input type="text" name="nomor_kamar" class="form-control" value="<?php echo $list['nomor_kamar']?>"></p>
