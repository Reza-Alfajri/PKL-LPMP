      ...
      <section id="list_mahasiswa" class="list_mahasiswa">
        <div class="container">
          <div class="section-title">
            <h2 data-aos="zoom-out" data-aos-delay="170">Kamar Wisma Anggrek</h2>
            <div class="container"> 
                <div class="ListDaftar" data-aos="fade-down" data-aos-delay="200">
                    <form action="kamar_anggrek.php" method="POST">
                        <fieldset>
                        <p><label for="timestamp">Timestamp : </label>
                              <input type="datetime" name="timestamp" class="form-control" value="<?php date_default_timezone_set('Asia/Jakarta'); echo date("Y/m/d H:i:s"); ?>"/></p>
                          ...
                          <p><label for="nip">NIK : </label>
                              <input type="text" name="nik" class="form-control"></p>
                          <p><label>Jenis Kelamin : </label>
                            ...
                            <p><input type="submit" value="Simpan" name="simpan" class="btn btn-primary" onclick="return simpan()"></p>
